...
export default function Chatbox() {
    ...
    const [promptreply, setpromptreply] = useState("Hello, Welcome to PowerzestAI⚡");

    const placeholders = [
        "What are the major products of Powerzest?",
        "Who is the CEO of Powerzest?",
        "What is the Innovation of Powerzest?",
        "Does Powerzest have a patent?",
        "How old is Powerzest?",
    ];
